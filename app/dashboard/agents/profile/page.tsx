...
export default function ProfilePage() {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            <header>
                <h1 className="text-3xl font-black text-slate-800">Agent Profile</h1>
                <p className="text-slate-500 font-medium font-medium">Manage your personal information and security</p>
            </header>
                ...
                <form onSubmit={handleUpdate} className="space-y-8">
                    <div className="flex flex-col md:flex-row items-center gap-8 pb-8 border-b border-slate-50">
                        <div className="relative group">
                            <div className="w-32 h-32 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-[2rem] flex items-center justify-center text-white shadow-xl">
                                <span className="text-4xl font-black">{session?.user?.name?.charAt(0).toUpperCase() || "A"}</span>
                            </div>
                        ...
                        <div className="text-center md:text-left">
                            <h3 className="text-2xl font-black text-slate-800">{session?.user?.name || "Agent Name"}</h3>
                            <p className="text-slate-500 font-medium font-medium flex items-center justify-center md:justify-start gap-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-2 opacity-60">
                            <label className="text-xs font-black text-slate-500 uppercase tracking-widest px-1">Email (Locked)</label>
                            <div className="relative">
